...
// Разделяем SimulationView на более мелкие компоненты
struct SimulationView: View {
    ...
    var body: some View {
        Form {
            ...
            safetySystemsSection
            resultsSection
            controlButtonsSection
            brakingAnimationSection
            saveButtonSection
        }
    ...
    // MARK: - Subviews
    private var mainParametersSection: some View {
    ...
    private var carParametersSection: some View {
    ...
    private var additionalParametersSection: some View {
    ...
    private var safetySystemsSection: some View {
        ...
        Section {
            HStack(spacing: 10) {
                Button(action: {
                    ...
                    HStack {
                        Image(systemName: animationVM.isAnimating ? "stop.fill" : "car.fill")
                        Text(animationVM.isAnimating ? "Остановить" : animationVM.buttonText)
                            .font(.headline)
                    }
                ...
                .disabled(animationVM.isAnimating)
            }
        }
    }
    
    private var brakingAnimationSection: some View {
